...
According to a recent study by Cisco \cite{ciscosurvey}~\ref{fig:ciscodata}
...
Akka is built on top of the \acf{JVM}, making it the most interesting implementation
...
software on top them, to \acf{SaaS}. SaaS exposes public \acf{HTTP}
\acf{API} as the entry point to their functionality. This category of software reuse
