...
are able to replicate changes among peers, they do not need coordination and are
have eventual strong consistency. Again, akka provides an extension that allows
working with \acs{CRDT}s, akka distributed data. With this akka extension it is
possible to subscribe to changes in certain \acs{CRDT}
...
To implement watermarks, a new type of \acs{CRDT} has been implemented, 
