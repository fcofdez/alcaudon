...
\drop{A}{lcaudon's} architecture will be described in this chapter following a top-down
...
that can be found at onatype OSSRH \footnote{http://central.sonatype.org/pages/ossrh-guide.html}.
...
In Alcaudon, each computation can subscribe to multiple sources represented as
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.6\textwidth]{membershipcluster.png}
...
First, cluster coordinator sends a request to a
